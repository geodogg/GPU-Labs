...
bool compareData(const float *output, const float *reference, const float *input, const int dimx, const int dimy, const int dimz, const int radius, const float tolerance=0.0001f);
